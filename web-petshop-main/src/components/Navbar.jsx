        ...
        <li className="dropdown">
          ...
          <div className="dropdown-menu">
            <ul className="product-dropdown">
              <li>
                <Link to="/products/cat">Gatos</Link>
              </li>
              <li>
                <Link to="/products/dog">Perros</Link>
              </li>
              <li>
                <Link to="/products/toys">Juguetes</Link>
              </li>
              <li>
                <Link to="/products/clothes">Ropa para Mascotas</Link>
              </li>
            </ul>
          </div>
        </li>
